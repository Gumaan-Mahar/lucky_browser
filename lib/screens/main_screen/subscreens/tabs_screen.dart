                  ...
                  onTap: () async {
                    ...
                    await showMenu(
                      ...
                      items: [
                        ...
                        popupMenuItem(
                            icon: Icons.close, title: 'Close all tabs'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    tab.url == null
                        ? GestureDetector(
                            onTap: () => {
                              mainProvider.selectedTabIndex = index,
                              // mainProvider
                              //     .updateTab(mainProvider.tabs[index].url),
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                            ...
                            child: Container(
                              ...
                              width: AppConstants.getScreenWidth(context) * 0.2,
                              height:
                                  AppConstants.getScreenHeight(context) * 0.2,
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              height:
                                  AppConstants.getScreenHeight(context) * 0.23,
                              child: ClipRect(
                                child: WebViewWidget(
                                  controller: mainProvider.webViewControllers[
                                      mainProvider.selectedTabIndex],
                                ),
                              ),
                            ),
                          ),
